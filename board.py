...
class WhitePawn(ChessPiece):
    ...
    def pawn1_set(self):
        ...
        image_pawn = self.whitep_transfrom.get_rect(topleft=(0, 0))
...
class ChessGame:
    ...
    def new_pos(self, n_pos):
        self.white_pieces.append(WhiteRook("White", n_pos))
        self.white_pieces.append(WhiteKnight("White", n_pos))
        self.white_pieces.append(WhiteBishop("White", n_pos))
        self.white_pieces.append(WhiteQueen("White", n_pos))
        self.white_pieces.append(WhiteKing("White", n_pos))
        self.white_pieces.append(WhiteBishop("White", n_pos))
        self.white_pieces.append(WhiteKnight("White", n_pos))
        self.white_pieces.append(WhiteRook("White", n_pos))

        # Create white pawns
        self.white_pieces.append(WhitePawn("White", n_pos))
        self.white_pieces.append(WhitePawn("White", n_pos))
        self.white_pieces.append(WhitePawn("White", n_pos))
        self.white_pieces.append(WhitePawn("White", n_pos))
        self.white_pieces.append(WhitePawn("White", n_pos))
        ...
        # Create black pieces
        self.black_pieces.append(BlackRook("Black", n_pos))
        self.black_pieces.append(BlackKnight("Black", n_pos))
        self.black_pieces.append(BlackBishop("Black", n_pos))
        self.black_pieces.append(BlackQueen("Black", n_pos))
        self.black_pieces.append(BlackKing("Black", n_pos))
        self.black_pieces.append(BlackBishop("Black", n_pos))
        self.black_pieces.append(BlackKnight("Black", n_pos))
        self.black_pieces.append(BlackRook("Black", n_pos))

        # Create black pawns
        self.black_pieces.append(BlackPawn("Black", n_pos))
        self.black_pieces.append(BlackPawn("Black", n_pos))
        self.black_pieces.append(BlackPawn("Black", n_pos))
        self.black_pieces.append(BlackPawn("Black", n_pos))
        self.black_pieces.append(BlackPawn("Black", n_pos))
