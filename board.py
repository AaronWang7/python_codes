...
class ChessGame:
    ...
    def setup_pieces(self):
        # Create white pieces
        self.white_pieces.append(WhiteRook("White", "A1", 0))
        self.white_pieces.append(WhiteKnight("White", "B1", 0))
        self.white_pieces.append(WhiteBishop("White", "C1", 0))
        self.white_pieces.append(WhiteQueen("White", "D1", 0))
        self.white_pieces.append(WhiteKing("White", "E1", 0))
        self.white_pieces.append(WhiteBishop("White", "F1", 0))
        self.white_pieces.append(WhiteKnight("White", "G1", 0))
        self.white_pieces.append(WhiteRook("White", "H1", 0))

        # Create white pawns
        self.white_pieces.append(WhitePawn("White", "A2", 0))
        self.white_pieces.append(WhitePawn("White", "B2", 0))
        self.white_pieces.append(WhitePawn("White", "C2", 0))
        self.white_pieces.append(WhitePawn("White", "D2", 0))
        self.white_pieces.append(WhitePawn("White", "E2", 0))
        self.white_pieces.append(WhitePawn("White", "F2", 0))
        self.white_pieces.append(WhitePawn("White", "G2", 0))
        self.white_pieces.append(WhitePawn("White", "H2", 0))

        # Create black pieces
        self.black_pieces.append(BlackRook("Black", "A8", 0))
        self.black_pieces.append(BlackKnight("Black", "B8", 0))
        self.black_pieces.append(BlackBishop("Black", "C8", 0))
        self.black_pieces.append(BlackQueen("Black", "D8", 0))
        self.black_pieces.append(BlackKing("Black", "E8", 0))
        self.black_pieces.append(BlackBishop("Black", "F8", 0))
        self.black_pieces.append(BlackKnight("Black", "G8", 0))
        self.black_pieces.append(BlackRook("Black", "H8", 0))

        # Create black pawns
        self.black_pieces.append(BlackPawn("Black", "A7", 0))
        self.black_pieces.append(BlackPawn("Black", "B7", 0))
        self.black_pieces.append(BlackPawn("Black", "C7", 0))
        self.black_pieces.append(BlackPawn("Black", "D7", 0))
        self.black_pieces.append(BlackPawn("Black", "E7", 0))
        self.black_pieces.append(BlackPawn("Black", "F7", 0))
