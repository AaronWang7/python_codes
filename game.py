...
can_move1 = WhitePawn.can_move(0, 0)
...
# black_pawns = []
# for i in range(8):
#     white_pawns.append(Pawn(i * 100, 445))
#     black_pawns.append(Pawn(i * 100, 70))

# white_bishops = []
# black_bishops = []
# j = 0
# for i in range(2):
#     white_bishops.append(Bishop(300*i, 525))
#     black_bishops.append(Bishop(300*i, 0))
